...
public class TestHospitalRankings_01 {
			...
			for (int k =3; k <totalurls; k++) {
					...
					//	int column_size = al.size();
						...
						for (z = 2; z < Columncount; z++) {
							...
							if(colName.equals("rank")|| colName.equals("score")) {
								Xpath= "//*[@data-test-id='"+colName+"']";	
							}else {
								Xpath= "(//*[@data-test-id='"+colName+"'])[2]";		
							}
						

							try {
								if(colName.contains("measure-intens") || colName.contains("measure-mag")||colName.equals("measure-nci")) //specify the column for which we have tick
								{
									System.out.println("col Na,me is "+colName);
